...
class Decoder(nn.Module):
    def __init__(self, in_channels=3,depth=3):
        ...
        self.interpolate_decoder= Interpolation_decoder( 12, in_channels * (4**depth), act=relu)
...
class CAIN(nn.Module):
    def __init__(self, depth=3):
        ...
        self.conv2 = nn.Conv2d(in_channels=3,out_channels=2,kernel_size=1,padding=0)
